...
<link rel="stylesheet" id="builder-overrides-css" href="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/builder-overrides.css" type="text/css" media="all">
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/post-edit-overrides.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/jquery.colorbox-1.4.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/jquery.magnific-popup.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/jquery.easing.1.3.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/jquery.fitvids.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/jquery.bxslider.min.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/6126-layout.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/jquery.throttle.min.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/jquery.magnificpopup.min.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/bootstrap.min.js.download"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/css/The Process - MRD Home Buyers_files/theme.js.download"></script>
  <style>
